...
class VaccinePopulate
{
    public static function populate(): void
    {
        try {
            ...
            foreach ($vaccinesDataList as $vaccineData) {
                $existing = Vaccine::where(['name' => $vaccineData['name']]);
            ...
            echo "Vaccines populated successfully.\n";
        } catch (\Throwable $e) {
            echo "Erro ao populate vaccines: " . $e->getMessage() . PHP_EOL;
        }
    }
}
