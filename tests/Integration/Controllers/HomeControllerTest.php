...
class HomeControllerTest extends ControllerTestCase
{
    ...
    {
        $emailInputPattern = '/<input type="text" class="border rounded-lg p-2" name="email" id="email">/';
        $passwordInputPattern = '/<input type="password" class="border rounded-lg p-2" name="password" id="password">/';
